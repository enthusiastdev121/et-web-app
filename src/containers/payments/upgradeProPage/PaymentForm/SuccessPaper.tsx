...
export default function SuccessPaper({ plan, state }: any) {
  ...
  return (
    <div className="shadow-md bg-pure rounded-2xl px-4 py-4 ml-auto mr-auto" style={{ maxWidth: 600 }}>
      {loading ? (
        ...
        <div>
          <div>
            ...
            <div className="text-center mb-3">
              ...
              <div className="mb-2">
                ...
                <strong> ${Number(featuredPlan?.pricePerCycle).toFixed(2)}/month </strong>
                Featured Talent
              </div>
          ...
          <div className="border border-gray-300 rounded-lg px-3 py-2 flex flex-col gap-2">
            <div>
              ...
              <LabValue>
                <div>{featuredPlan?.pricePerCycle} Featured monthly</div>
                <div>${Number(featuredPlan?.pricePerCycle).toFixed(2)}</div>
              </LabValue>
            </div>{" "}
          </div>
        </div>
          ...
          <div className="border border-gray-300 rounded-lg px-3 py-2 flex flex-col gap-2">
            ...
            <div>
              ...
              <LabValue>
                ...
                <div>${Number(plan?.price_per_cycle).toFixed(2)}/Month</div>
              </LabValue>
            </div>
          </div>
        </div>
