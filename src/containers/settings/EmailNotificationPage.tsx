      ...
      <Main>
        <div style={{ maxWidth: "600px", margin: "0 auto" }}>
          <Nav>
            ...
            <div className="mr-auto title">Email Notification</div>
          </Nav>

          <div>
            <div
              className="flex txt-gray items-center justify-between mb-8"
            >
              <div>
                Emails are sent to <strong>adamsandman@gmail.com</strong>{" "}
              </div>
              <button className="txt-link font-semibold">Change</button>
            </div>

            <div
              className="flex txt-gray items-center justify-between mb-5"
            >
              <h2 className="font-semibold text-xl text-gary-400 ">
                Receive all email notification
              </h2>
              <ToogleContainer>
