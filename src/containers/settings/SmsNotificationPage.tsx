      ...
      <Main>
        <div style={{ maxWidth: "600px", margin: "0 auto" }}>
          <Nav>
            ...
            <div className="mr-auto title">SMS Notification</div>
          </Nav>

          <div>
            <div
              className="txt-gray flex items-center justify-between mb-8"
            >
              <div>
                SMS are sent to <strong>+63 914 978 4468</strong>
              </div>
              <button className="txt-link font-semibold">Change</button>
            </div>

            <div
              className="txt-gray flex items-center justify-between mb-5"
            >
              <h2 className="font-semibold text-xl text-gary-400 ">
                Receive all sms notification
              </h2>
              <ToogleContainer>
