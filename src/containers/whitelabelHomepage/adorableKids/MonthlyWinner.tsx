...
import AdorableKidsCardCarousel from "./Caruosel";
...
export default function MonthlyWinner() {
  return (
    <Root>
      <p className="sub_heading">Monthly Winners</p>
      <h1 className="heading">Other Winners</h1>
      <div className="">
        <AdorableKidsCardCarousel ht={"94%"}>
          {category.map((i) => (
            <Link href="/auditions" key={i.id}>
              <a>
                <Card>
