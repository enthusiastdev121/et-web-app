    ...
    <Parent className="relative">
      <div
        ...
        style={{
          ...
          left: -123,
          top: -260,
          background: "url('/images/Features_18.png')",
      ...
      <div
        ...
        style={{
          ...
          left: -43,
          top: 50,
          background: "url('/images/Features_19.png')",
          backgroundRepeat: "no-repeat",
        }}
      ></div>
      <Root>
      <FontFamily>   <h2>Community and Job opportunity <span style={{}} ><br/>for everybody!</span> </h2> </FontFamily>

        <div className="mt-16 grid md:grid-cols-2 lg:grid-cols-4 gap-5 justify-items-center">
          <FeatureCard>
            <Image 
              className=""
              src="/images/manila_models/note_manila.svg"
              alt="notes"
              width={80}
              height={80}
              priority={true}
          ...
          <FeatureCard>
            <Image
              src="/images/manila_models/member_manila.svg"
              alt="user profile"
              width={80}
              height={80}
              priority={true}
          ...
          <FeatureCard>
            <Image
              src="/images/manila_models/contact.svg"
              alt="creators"
              width={80}
              height={80}
              priority={true}
          ...
          <FeatureCard>
            <Image
              src="/images/manila_models/cap.svg"
              alt="notes"
              width={80}
              height={80}
              priority={true}
