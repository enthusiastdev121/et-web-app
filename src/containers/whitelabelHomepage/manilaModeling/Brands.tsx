...
export default function Brands() {
  ...
  return (
    <FontFamily>
      <Root className="bg-white shadow-xl flex gap-5 flex-col lg:flex-row items-center lg:gap-10 justify-center">
      <h2 className="p-10">Our&nbsp;talents&nbsp;have&nbsp;been&nbsp;featured&nbsp;on</h2>
      <>
        <CardCarousel>
