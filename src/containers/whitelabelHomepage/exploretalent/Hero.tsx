    ...
    <Root className="flex items-center flex-col lg:flex-row justify-center">
      ...
      <div className="mb-20 relative z-10">
        <h1 className="mt-10 sm:mt-20 md:mt-28 lg:mt-36">
          ...
          <span style={{ color: "#0070F4" }}> talents </span> <br />
          <span style={{ fontSize: 35 }}>with Casting Professionals.</span>
        </h1>
        <p style={{ maxWidth: 616 }}>
          World&apos;s Largest Talent Network with over 11 million users
        </p>
