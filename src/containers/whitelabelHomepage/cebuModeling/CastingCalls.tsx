  ...
  return (
    <div className="casting-card">
      ...
      <div className="flex gap-3 items-center my-4 text-sm">
        <div className="font-medium category_text">
...
export default function CastingCalls() {
  ...
  return (
    <div
      ...
      className="pb-5"
    >
      <Root className="flex items-center justify-center gap-5 flex-col lg:flex-row">
        {/* heading text */}
        <div className="heading-container lg:-mt-20">
          <div className="heading-top">Casting Calls</div>
          <h2 className="">Ongoing <span className="category_text">{category}</span><br />Castings for today</h2>
        </div>
