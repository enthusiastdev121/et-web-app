  ...
  return (
    <div
      style={{
        ...
        background: "linear-gradient(to right, #f5857d ,#f5857d ,  #6A67E3, #f5857d)",
      }}
    >
      <Root className="flex gap-10 items-center flex-col lg:flex-row">
        ...
        <div className="right mb-20 xl:mb-0 text-center lg:text-left">
          ...
          <Link href="/join/talentb" passHref>
            <button className="create_kids_button"><span className="text-[24px]">+</span> Create&nbsp;your&nbsp;kid&nbsp;a&nbsp;profile</button>
          </Link>
        </div>
      </Root>
    </div>
