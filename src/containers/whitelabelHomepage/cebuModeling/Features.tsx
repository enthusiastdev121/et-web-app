    ...
    <Parent className="relative">
      <div
        ...
        style={{
          ...
          left: -123,
          top: -260,
          background: "url('/images/cebuModeling/bg-1.png')",
      ...
      <div
        ...
        style={{
          ...
          left: -43,
          top: 50,
          background: "url('/images/cebuModeling/bg-2.png')",
          backgroundRepeat: "no-repeat",
        }}
      ></div>
      <Root>
        ...
        <div className="mt-16 grid md:grid-cols-2 lg:grid-cols-4 gap-5 justify-items-center">
          <FeatureCard>
            <Image
              src="/images/cebuModeling/Icons/home-note.png"
              alt="notes"
              width={60}
              height={60}
              priority={true}
          ...
          <FeatureCard>
            <Image
              src="/images/cebuModeling/Icons/home-profile-user.png"
              alt="user profile"
              width={60}
              height={60}
              priority={true}
          ...
          <FeatureCard>
            <Image
              src="/images/cebuModeling/Icons/home-user-octagon.png"
              alt="creators"
              width={60}
              height={60}
              priority={true}
          ...
          <FeatureCard>
            <Image
              src="/images/cebuModeling/Icons/home-teacher.png"
              alt="notes"
              width={60}
              height={60}
              priority={true}
...
const Parent = styled.div`
 background: linear-gradient(96.61deg, rgba(255, 236, 230, 0.1) 2.1%, #FFEEEE 33.91%, #F7E9FF 66.03%, #D9DDFF 100%);
  .small-grad {
