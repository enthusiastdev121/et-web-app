...
export default function OldLookingHire() {
            ...
            <Container>
                <div className="xl:grid 2xl:grid-cols-2 xl:grid-cols-3 gap-4 hiresection">
                    <div className="looking-hire 2xl:col-span-1 col-span-1 pr-4">
                        ...
                        <h6>Reach professional talent and fresh faces by placing a free casting call. See applicants' experience, photos, videos, audio and more. Easily sort applications, make notes on them and cast the perfect talent. Contact and book talent direct.</h6>
                        <button>+ List a job (FREE)</button>
                    </div>
                    <div className="testimonial relative 2xl:col-span-1 xl:col-span-2 xl:mt-0 mt-12">
                        <div className="testimonial-header">
                            <h5>What our happy clients say</h5>
                        ...
                        <Slider {...settings} className="slider-card">
                            <div className="single-testimonial">
                                ...
                                <p>“Explore Talent is the No. 1 supplier of referrals to our registration page across every region for the entire tour!”</p>
                            </div>
                            <div className="single-testimonial">
                                <img src="/images/testimonial-one.png" alt="" />
                                <h5>Tamzine walshe</h5>
