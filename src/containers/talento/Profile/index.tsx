                    ...
                    <div className="lg:flex ">
                        ...
                        <div className="profile-info ml-10">
                            <div className="profile-info-content">
                                <h3 className="user-name text-white">Adam Sandman, 23</h3>
                                <p className="user-archivements text-white">Actor, Extra, Influencer, Singer, Sound Crew Member, Editor / Post Production Staffe, ... <span>more</span></p>
                ...
                <CommentSection>
                    <div id="target19">
                        <div className="latest-comment">
                            <img src="/images/comment.png" alt="messages" />   <h5>Latest Comments</h5>
                        </div>
...
const DancingSec = styled.div`
    ...
    box-shadow: 0px -3px 15px rgb(0 0 0 / 2%), 0px 7px 8px 2px rgb(0 0 0 / 5%);
