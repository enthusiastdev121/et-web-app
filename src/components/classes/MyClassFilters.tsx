...
export default function MyClassFilters({ ethnicity, searchTerm, setSearchTerm, setEthnicity, gender, setGender, onFind, zip, setZip, worldWide, location, loadingLoc, setDistance, distance, ageRange, setAgeRange, onReset }: any) {
        ...
        <div className="mt-3">
            ...
            <div className="flex justify-between items-center mt-5">
                <div className="text-lg">
                    <strong>4</strong> classes you own
                </div>
                        ...
                        <ClickAwayListener onClickAway={() => setShowSort(false)}>
                            <div className="absolute top-[55%] z-20 right-0 sm:left-[-10%] text-sm lg:text-base">
                                <div className="my-5 bg-pure rounded-[6px] min-w-[200px] shadow-md p-[3px]">
                                    <ul>
                                        <ListItem
                                            active={activeSort === "Sort by recently accessed"}
                                            onClick={() => {
                                                setActiveSort("Sort by recently accessed")
                                                setShowSort(false)
                                            }}>Sort by recently accessed</ListItem>
                                        <ListItem
